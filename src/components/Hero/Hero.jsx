  ...
  return (
    <div className="w-full block h-auto pb-16 lg:flex  items-center justify-center ">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-start justify-center lg:pb-0 lg:pt-0 pt-14 pb-20">
        <span className="w-full lg:w-80 font-Mulish text-base lg:text-lg">
        ...
        <span className="font-Mak-Bold text-7xl lg:text-9xl pt-12 pb-5 lg:pb-0 lg:pt-20">
          Don't stop reading
        </span>
      </div>
      {/* Right Section */}
      <div className="w-full lg:w-1/2 flex flex-col items-start  lg:pl-10 justify-center relative">
        ...
        <div className="absolute -right-3 lg:right-0 bottom-5 lg:bottom-0 bg-primary-col font-Mulish text-sm lg:text-base text-white w-20 h-20 lg:w-28 lg:h-28 flex items-center justify-center rounded-full">
