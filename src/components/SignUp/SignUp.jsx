...
export default function SignUp() {
    ...
    return (
    <div className="bg-dark w-full min-h-screen text-white px-8 font-Mulish">
      <div className="w-full flex items-center justify-start py-8">
        <button className="w-10 border rounded-md border-gray-100 h-10 p-3 flex items-center justify-center text-xl border-opacity-20">
          <i className="ri-arrow-left-s-line"></i>
        </button>
        <span className="pl-5 text-2xl font-extrabold">Sign Up</span>
      </div>
      <div className="w-full">
          <span className="text-xs font-light inline-block mb-5">Sign up with one of following options.</span>
        <button className="border rounded-lg h-12 bg-grey border-gray-100 w-full py-2 flex items-center justify-center outline-none  text-sm border-opacity-10">
          <svg
            className="mr-5"
            width="20"
            height="20"
      ...
      <form action="" className="w-full mt-5" autoComplete="off">
          <div className="input-group flex items-start justify-center flex-col my-3 ">
              ...
              <input type="text" name="name" id="name" placeholder="Eg : John Doe" className="p-3 mt-2 border rounded-lg h-12 bg-grey border-gray-100 w-full py-2 flex items-center justify-center outline-none  text-sm border-opacity-10"/>
          </div>
      </form>
    </div>
  );
